...
<!-- = ----------------------------------------------------------------------------------------------- = -->
<!-- [필수] 사용자 인증 정보 -->
<input type="hidden" name="uid" value="icloser" />
<input type="hidden" name="pwd" value="smartsw2190" />
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="400">
      <!-- [선택] 문자 전송제목 -->
      <input name="title" type="text" value="학과사무실에서 알립니다" />
    </td>
  </tr>
  <tr>
    <td>휴대폰번호</td>
    <td>
      ...
      <input name="toNumber" type="text" value="<%=phoneNumber %>" />
    </td>
  </tr>
  <tr>
    <td>전송내용</td>
  ...
  <tr>
    ...
    <td>
      ...
      <input name="fromNumber" type="text" value="0115574027" />
    </td>
  </tr>
  <tr>
    <td>전송시간</td>
...
<input name="returnUrl" type="hidden" value="http://localhost:8080/Lab/indexManager.jsp" />
<!-- = ----------------------------------------------------------------------------------------------- = -->
<!-- = 4. 전송결과 처리 방식 입력 END                                                                  = -->
<!-- =================================================================================================== -->
...
<!-- = ----------------------------------------------------------------------------------------------- = -->
<input name="returnType" type="hidden" value="2" />
<input name="redirectUrl" type="hidden" value="http://localhost:8080/Lab/indexManager.jsp" />
<!-- = ----------------------------------------------------------------------------------------------- = -->
<!-- = 5. 전송후 처리 방식 입력 END                                                                    = -->
<!-- =================================================================================================== -->
...
<table width="500" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center">
      ...
      <input type="submit" name="button" value="문자발송" />
    </td>
  </tr>
</table>
</form>    
