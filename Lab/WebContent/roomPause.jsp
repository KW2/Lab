...
<body>
   ...
   <form class="form-inline" id="info_form" action="RoomProcess.jsp" method="post" onsubmit="return false;">  
 ...
 <label for="datepicker1">조회 기간 : </label>
  ...
  <div class="form-group">
   ...
   <input type='button' class="btn btn-default" value='조회' onclick="getInfo(1, true)"/>
</form> 
      ...
      <p/>
      <div class="col-xs-3">
      <input class="form-control" width="50px" type='text' name='reason'/>
      </div>
      <input class="btn btn-default" type='button' id='coldbutton' value='얼리기' disabled="true" onclick="cold(1, true)"/>
      <p/>
